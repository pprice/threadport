...
export function ApiHarness() {
  ...
  const [state, setState] = useState<ChatViewportState | null>(null)
  ...
  return (
    <main className="apiHarness">
      <section className="apiControls" aria-label="API harness controls">
        ...
        <button data-testid="api-append-tail" type="button" onClick={appendReservedTail}>
          Append
        </button>
      ...
      <ChatViewportFrame className="apiFrame">
        <ChatVirtualViewport
          ref={viewportRef}
